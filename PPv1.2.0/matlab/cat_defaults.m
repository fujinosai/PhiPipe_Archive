...
% this file was used in t1_cat.sh
...
%_______________________________________________________________________
% this file was modified based on CAT12's cat_defaults.m
% It is possible this file may not work for future CAT12

if exist('cat','var'), clear cat; end 
global cat

% global variables used to tune the performance of brain extraction
global ALGO
global CLEANUP
...
% save ROI values
cat.output.ROI         = 0;     % write xml-file with ROI data (0 - no, 1 - yes (default))
...
cat.extopts.gcutstr      = ALGO;    % Strength of skull-stripping:               0 - SPM approach; eps to 1  - gcut; 2 - new APRG approach; -1 - no skull-stripping (already skull-stripped); default = 2
cat.extopts.cleanupstr   = CLEANUP;  % Strength of the cleanup process:           0 to 1; default 0.5
